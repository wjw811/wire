...
/*{{{ decode */
    public function decode($pack) {
        ...
        if ($x[3] == 67 && $x[4] == 75) {
            ...
            $d['f48'] = $this->e($x[101], 5, [0, 1, 2, 3, 4, 5, 6, 7]); //故障及状态信息5
            $d['f49'] = $this->e($x[102], 4, [0, 1, 2, 3, 4, 5, 6, 7]); //故障及状态信息4
            $d['f50'] = $this->e($x[103], 3, [0, 1, 2, 3, 4, 5, 6, 7]); //故障及状态信息3
            $d['f51'] = $this->e($x[104], 2, [0, 1]); //故障及状态信息2
